...
export const Card = React.memo(({
  ...
  <div
    ...
    onClick={onClick}
    className={cn(
      "rounded-3xl relative bg-gray-100 overflow-hidden h-[400px] w-full transition-all duration-500 ease-out cursor-pointer border border-gray-100",
    ...
    <div
      ...
      <div className="w-full">
        <div className="text-primary-400 text-xs text-white font-bold tracking-widest uppercase mb-1">{card.position}</div>
